...
class User(AbstractUser):
    ...
    moblie = models.CharField(max_length=11, blank=True, null=True, verbose_name='手机号码')
    url = models.URLField(max_length=120, blank=True, null=True, verbose_name='个人网站')
...
class Comment(models.Model):
    ...
    email = models.CharField(max_length=50, blank=True, null=True, verbose_name='邮箱地址')
    url = models.URLField(max_length=120, verbose_name='个人网站地址', blank=True, null=True)
    date_publish = models.DateTimeField(auto_now_add=True, verbose_name='发布时间')
...
class Links(models.Model):
    ...
    callback_url = models.URLField(max_length=120, verbose_name='url地址')
    date_publish = models.DateTimeField(auto_now_add=True, verbose_name='发布时间')
